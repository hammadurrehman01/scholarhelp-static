      ...
      <div className="mx-auto max-w-screen-xl ">
        <div className="py-20 px-5 md:py-44">
          ...
          <div className="max-w-screen-md mx-auto text-center pt-4 font-medium dark:text-zinc-100 text-zinc-900 sm:text-lg text-sm ">
            The name says all, Our online podium is a place where hundreds of
            students seek expert guidance to solve their academic problems and
            initialize supportive guidelines to tailor their needs. Our expert
            team is essential to provide flawless and top-quality work to ensure
